 ...
 ******************************************************************************/
package com.shinoow.darknesslib.client.render.entity.layers;

import java.util.UUID;

import com.shinoow.darknesslib.client.model.player.ModelStarSpawnPlayer;
...
public class LayerStarSpawnTentacles implements LayerRenderer<EntityPlayer> {
	...
	private final ResourceLocation texture = new ResourceLocation("darknesslib:textures/model/tentacles.png");
